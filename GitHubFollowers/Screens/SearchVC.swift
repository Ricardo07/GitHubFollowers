...
//    var logoImageViewTopConstraint: NSLayoutConstraint!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        view.backgroundColor = .systemBackground // to implement the darkmode
    ...
    func configureLogoImageView() {
        ...
        // This was used to adjust for the old iPhone Se
...
//        logoImageViewTopConstraint.isActive = true
    ...
    func configureTextField() {
        ...
        NSLayoutConstraint.activate([
            ...
            usernameTextField.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -50), // the constant is negative
